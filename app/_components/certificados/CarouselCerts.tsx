...
const slides = [
  ...
  {
    id: 2,
    title: "Vinculado a melhor Certificadora do Brasil",
    description: "Entre em contato e se torne um parceiro, faça parte da família.",
    image: "/certificado3.png",
  },
  {
    id: 3,
    title: "Trabalhamos com agentes especializados",
    description: "Encontre o melhor atendimento com uma empresa confiável.",
    image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=1920&q=80",
  },
];

export default function CarouselCerts() {
